...
[^1]: Yes, there are still 486-class CPUs being made; the "Vortex86" line is a real hoot.
...
[^3]: I can't tell if the Cyrix Cx5x86 is or isn't an "i586" in terms of instruction set,
      and I'm not taking my chances with the AMD 586s or the "(enhanced)" 486s, either.

[^4]: The "or better" part is why the PlayStation 5 has a dedicated decompression unit;
...
[^5]: I've had this set to use PCap networking instead of SLiRP; I've had 86Box
